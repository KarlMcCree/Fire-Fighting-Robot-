...
// #define FLAME_SENSOR_1_PIN 13
// //#define FLASH_PIN 4  // Built-in flash pin on ESP32-CAM
...
// void setup() {
//   // Start Serial at correct baud rate
//   Serial.begin(115200);
...
//   config.fb_count = 2;       // if more than one, i2s will be used
...
//   int flame1 = digitalRead(FLAME_SENSOR_1_PIN);

//   if (flame1 == HIGH) {
//     Serial.println("Fire detected! Starting stream...");
