...
// //   server.on("/", []() {
// //     server.send(200, "text/html", "<h2>Robot Remote</h2>\
// //       <button onclick=\"fetch('/cmd?move=1')\">Forward</button>\
// //       <button onclick=\"fetch('/cmd?move=2')\">Backward</button>\
// //       <button onclick=\"fetch('/cmd?move=3')\">Left</button>\
// //       <button onclick=\"fetch('/cmd?move=4')\">Right</button>\
// //       <button onclick=\"fetch('/cmd?move=0')\">Stop</button>");
// //     });

// //   server.on("/status", []() {
// //    server.send(200, "text/plain", "Robot is online and functioning.");
// //   });


// // server.on("/cmd", []() {
// //   if (server.hasArg("move")) {
// //     int cmd = server.arg("move").toInt();
// //     if (cmd >= 0 && cmd <= 4) {
// //       remoteCommand = cmd;
// //       manualMode = true;
...
//   //     manualMode = false;
//   //     stopMotors();
//   //     Serial.println("Manual control timeout — returning to autonomous mode.");
//   //   }
//   // }
